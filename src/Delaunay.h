...
public:
	triangle() {
		m_Vertices[0] = new vertex();
		m_Vertices[1] = new vertex();
		m_Vertices[2] = new vertex();
		SetCircumCircle();
	}
	...
	triangle & operator=(const triangle &tri) const {
		...
		triangle * retorno = new triangle(tri);
		return *retorno;
	}
	triangle & operator=(const triangle &tri) {
		...
		t->show();
		this->m_Vertices[0] = tri.GetVertex(0);
		this->m_Vertices[1] = tri.GetVertex(1);
		this->m_Vertices[2] = tri.GetVertex(2);
	...
	**/
	...
	void show() {
		cout << "X0: " << m_Vertices[0]->GetX() << " Y0: " << m_Vertices[0]->GetY() << endl;
		cout << "X1: " << m_Vertices[1]->GetX() << " Y1: " << m_Vertices[1]->GetY() << endl;
		cout << "X2: " << m_Vertices[2]->GetX() << " Y2: " << m_Vertices[2]->GetY() << endl;
	}
protected:
...
typedef list<triangle>::iterator ltIterator;
